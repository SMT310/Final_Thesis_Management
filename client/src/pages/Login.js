...
export default function CustomizedLogin() {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const CLIENT_ID =
    "795154931381-npgldkbjojtham774jbh1193sji0d6fi.apps.googleusercontent.com";
  ...
  return (
    ...
    >
      ...
      <Box
        component="div"
        sx={{
          background: "url(your-custom-background-image.jpg)", // Replace with your custom background image
          backgroundRepeat: "no-repeat",
          backgroundColor: "black", // Replace with your custom background color
          backgroundSize: "cover",
          backgroundPosition: "center",
          position: "absolute",
          width: "100%",
      ...
      >
        ...
        >
          ...
          {/* Customized Google login button */}
          <GoogleLogin
            clientId={CLIENT_ID}
            buttonText="Login with Google"
            onSuccess={onSuccess}
